...
export default function Home() {
  ...
  useEffect(() => {
    ...
    tl.fromTo(".phone-icon-left", {}, {}, "0");

    images.forEach((image, index) => {
      let xOffset;
      let yOffset;
      let direction;
      if (image.classList.contains("img-left")) {
        direction = -1;
      } else {
        direction = 1;
      }
      xOffset = ((index % 3) + 1) * 100 * direction;
      if (image.classList.contains("top-left")) {
        xOffset = -100;
        yOffset = -200;
      }
      if (image.classList.contains("mid-left")) {
        yOffset = 0;
        xOffset = -200;
      }
      if (image.classList.contains("bottom-left")) {
        yOffset = 100;
        xOffset = -300;
      }

      if (image.classList.contains("top-right")) {
        xOffset = -100;
        yOffset = -200;
      }
      if (image.classList.contains("mid-right")) {
        yOffset = 0;
        xOffset = 200;
      }
      if (image.classList.contains("bottom-right")) {
        yOffset = 100;
        xOffset = 500;
      }
    ...
    >
      ...
      <div ref={containerRef} className="h-[250vh] border-4 relative">
        ...
        >
          <div
            ref={imagesRef}
            className="absolute w-full left-0 top-0 inset-0 pointer-events-none"
          >
            <div className="floating-image top-left absolute top-[7%] left-[20%]">
              <img
                src="https://cdn.prod.website-files.com/65240dac30f703b7a711b7c2/652449efbd7b5c2a5845c8bd_04.webp"
                alt="Decorative element"
                width={60}
                height={60}
                className="w-[110px] h-[150px] -rotate-12"
              />
            </div>
            <div className="floating-image absolute rotate-[30deg] img-left mid-left top-[40%] -left-6">
              <img
                src="	https://cdn.prod.website-files.com/65240dac30f703b7a711b7c2/652449ef5a1ef1b3ae6a6017_08.webp"
                alt="Decorative element"
                width={80}
                height={80}
                className="w-[110px] h-[150px] rotate-12"
            ...
            <div className="floating-image absolute img-left bottom-left bottom-[10%] left-[10%]">
              <img
                src="https://cdn.prod.website-files.com/65240dac30f703b7a711b7c2/652449ef491c37dc82625698_07.webp"
                alt="Decorative element"
                width={100}
                // height={70}
                className=" w-40"
            ...
            <div className="floating-image absolute -rotate-[30deg] top-right top-[5%] right-[25%]">
              <img
            ...
            <div className="floating-image absolute mid-right -rotate-12 top-[10%] right-[0%]">
              <img
            ...
            <div className="floating-image absolute top-[40%] mid-right right-[5%]">
              <img
            ...
            <div className="floating-image absolute bottom-right bottom-[0%] -rotate-12 right-[20%]">
              <img
          ...
          <div className="w-full h-full absolute left-0 flex justify-center items-center">
            ...
            >
              <div className=" relative flex justify-center items-center phone-image top-[85vh]">
                <div className="absolute w-[80%]  z-[1000] border-4 h-[60%] top-[15%] flex justify-center items-center">
                  <div className="absolute w-[40%] z-50 -translate-x-[24vw] -translate-y-[59vh] top-[9%] bd-hat">
                    <img
                      ...
                      alt=""
                      className="full  -rotate-[20deg]"
                    />
                    <img
                      src="https://cdn.prod.website-files.com/65240dac30f703b7a711b7c2/652449ee5f4f1219afb378e1_02_inner.webp"
                      alt=""
                      className="w-full absolute top-0 left-0 -rotate-[20deg]"
                    />
                  </div>

                  <div className="absolute w-[70%] z-50 translate-x-[30vw] -translate-y-[85vh] top-[46%] happy-bd">
                    <img
                      src="https://cdn.prod.website-files.com/65240dac30f703b7a711b7c2/652d8fa21be7148e891e03f8_sticker_11_outline.webp"
                      alt=""
                      className="full rotate-[20deg]"
                    />
                    <img
                      src="https://cdn.prod.website-files.com/65240dac30f703b7a711b7c2/652d8fa20188a0894b2187e1_sticker_11_inner.webp"
                      alt=""
                      className="w-full absolute top-0 left-0 rotate-[20deg]"
                    />
                  </div>
                </div>
                <div className="w-28 h-20 -rotate-45 phone-icon-left rounded-full -translate-x-1/2 absolute phone-left left-1/4 -top-[50%] z-50"></div>
                <div className="w-28 rotate-12 h-20 phone-icon-right rounded-full absolute right-1/4 -top-[45%]"></div>

                {/* <PhoneMockup /> */}
                {/* <div className="w-[385px] relative h-[560px] border-4">
                  <img
                ...
                {/*  */}
                {/*  */}
                <div className="w-full  max-w-[385px] relative z-50">
                  {/* Phone backgrounds */}
                    ...
                    <div className="relative w-full h-full overflow-hidden z-10">
                      <div className="absolute w-full top-0 left-0 text-black">
                        ...
                        >
                          ...
                          <path
                            opacity=".6"
                            d="M592.062 48.092c1.224 0 2.215.991 2.215 2.215v.553a2.214 2.214 0 0 1-2.215 2.215v-4.983Z"
                            fill="currentColor"
                          ></path>
                        </svg>
                      </div>
