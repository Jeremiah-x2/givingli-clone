...
export default function Hero() {
  ...
  useEffect(() => {
    ...
    images.forEach((image, index) => {
      ...
      const xOffset = ((index % 3) + 1) * 100 * direction;
      const yOffset = ((index % 2) + 1) * 80 * direction;
  ...
  useEffect(() => {
    ...
    // });
    // tl.addLabel("start")
    //   .from(".phone-mock", { scale: 0.7 })
    //   .to(".phone-mock", { scale: 1 })
    //   .addLabel("end");
  }, []);
  ...
  return (
    <>
      <section
        ref={heroRef}
        className="container w-[100vw] h-[100dvh] relative flex items-center justify-center"
      >
        <div className="fadeout mb-40 relative flex flex-col items-center">
          <div className="w-28">
            <svg
          ...
          <div>
            <h2 className=" font-larken text-4xl font-bold mb-4">
              Easy <br />
              Thoughtful <br />
              Gifting
            </h2>
        ...
        <div className="absolute w-full h-full top-0 left-0">
          ...
          >
            <div className="floating-image absolute top-[0] left-[10%]">
              <img
            ...
            <div className="floating-image absolute top-[40%] left-0">
              <img
            ...
            <div className="floating-image absolute bottom-[20%] left-[10%]">
              <img
            ...
            <div className="floating-image absolute top-[5%] right-[25%]">
              <img
            ...
            <div className="floating-image absolute top-[10%] right-[0%]">
              <img
            ...
            <div className="floating-image absolute top-[40%] right-[5%]">
              <img
            ...
            <div className="floating-image absolute top-[60%] right-[20%]">
              <img
          ...
          {/* Mockup Container */}
          <div className="mockup absolute top-0 w-full h-full flex justify-center items-center ">
            {/* <div>
          <div className="w-20 h-20 rounded-full bg-red-500 -left-32 -top-20 relative"></div>
          <div className="w-20 h-20 rounded-full bg-red-500 relative -top-28 -right-36"></div>
        </div> */}

            {/* Phone Mockup */}
            <div className="phone-mock relative top-[70%]">
              {/* <img
